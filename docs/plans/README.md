...
The backend roadmap sequence currently spans `V2` through `V7-I`. Read them in order when you want the architecture story behind the current self-hosted gateway.
...
| `V7-I` | 2026-03-14 | Conversation-level merge/replace impact counts in pulled previews | [`2026-03-14-backend-v7i-pulled-preview-impact-counts-roadmap.md`](./2026-03-14-backend-v7i-pulled-preview-impact-counts-roadmap.md) | Proposed / current latest roadmap |
...
13. Read [`2026-03-14-backend-v7i-pulled-preview-impact-counts-roadmap.md`](./2026-03-14-backend-v7i-pulled-preview-impact-counts-roadmap.md) for the latest conversation-level import impact preview layer.
